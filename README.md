...
| <a name="input_flow_log_cloudwatch_log_group_deletion_protection_enabled"></a> [flow\_log\_cloudwatch\_log\_group\_deletion\_protection\_enabled](#input\_flow\_log\_cloudwatch\_log\_group\_deletion\_protection\_enabled) | If true, enables CloudWatch log group deletion protection | `bool` | `false` | no |
